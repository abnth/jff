...
class Ticket(models.Model):
	user_id=models.EmailField(blank=False)
	topic_id=models.CharField(max_length=100,blank=False)
	message=models.TextField()
	ticket_id=models.IntegerField()
	#file_uploads=models.FileField(upload_to='tickets/file' , blank=True)
	created_date_time=models.DateTimeField(editable=False,auto_now_add=True)
	overdue_date_time=models.DateTimeField(editable=False,auto_now_add=True)
	closed_date_time=models.DateTimeField(editable=False,auto_now_add=True)
	status=models.IntegerField()
	reopened_date_time=models.DateTimeField(editable=False,auto_now_add=True)
